          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto pointer-events-auto">
            ...
            >
              ...
              <motion.span 
                ...
                className="bg-gradient-to-br from-[#F7F3EA] via-[#C59A55] to-[#A67C37] bg-clip-text text-transparent block mt-3 text-6xl md:text-[9rem] font-normal drop-shadow-[0_12px_48px_rgba(197,154,85,0.6)] brightness-125 animate-float-slow"
              >
                importa.
              </motion.span>
            </motion.h1>
